...
public class KeyStoreHelper {
     ...
     */
    public synchronized static void createKeys(Context context, String alias) throws NoSuchProviderException,
    ...
    public synchronized static String getPuclicKey(String alias) {
        return Base64.encodeToString(getPrivateKeyEntry(alias).getCertificate().getPublicKey().getEncoded(), Base64.NO_WRAP);
    }

    public static Observable<String> getPublicKey(final String alias) {
        return Observable.create(new ObservableOnSubscribe<String>() {
            @Override
            public void subscribe(ObservableEmitter<String> emitter) throws Exception {
                for (int i = 0; i < 10000; i++) {
                    emitter.onNext(Base64.encodeToString(getPrivateKeyEntry(alias).getCertificate().getPublicKey().getEncoded(), Base64.NO_WRAP));
    ...
    public static Observable<String> getPublicKeys(final String alias) {
        return Single.create(new SingleOnSubscribe<String>() {
            @Override
            public void subscribe(SingleEmitter<String> emitter) throws Exception {
                emitter.onSuccess(Base64.encodeToString(getPrivateKeyEntry(alias).getCertificate().getPublicKey().getEncoded(), Base64.NO_WRAP));
